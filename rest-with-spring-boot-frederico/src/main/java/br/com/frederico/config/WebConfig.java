package br.com.frederico.config;
...
public class WebConfig implements WebMvcConfigurer {
    ...
    public void configureContentNegotiation(ContentNegotiationConfigurer configurer) {
        ...
        // Via EXTENSION. http://localhost:8080/api/person/v1/1.xml or
        // http://localhost:8080/api/person/v1/1.JSON Deprecated on Spring Boot 2.6
        ...
        configurer.favorParameter(false)
                ...
                .defaultContentType(MediaType.APPLICATION_JSON).mediaType("json", MediaType.APPLICATION_JSON)
                .mediaType("xml", MediaType.APPLICATION_XML).mediaType("yaml", MediaType.APPLICATION_YAML);
    }
}
